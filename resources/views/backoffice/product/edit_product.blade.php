                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="buying_date" class="form-control @error('buying_date') is-invalid @enderror" value="{{$product->buying_date}}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" name="expire_date" class="form-control @error('expire_date') is-invalid @enderror" value="{{$product->expire_date}}">
