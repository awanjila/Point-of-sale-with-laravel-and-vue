            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">THE PAGE YOU ARE LOOKING FOR DOES NOT EXIST</p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">Return to <a href="/dashboard" class="text-white ms-1"><b>Dashboard</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
...
<footer class="footer footer-alt">
     <script>document.write(new Date().getFullYear())</script> &copy; POS by <a href="https://api.whatsapp.com/send/?phone=254781312070&text&type=phone_number&app_absent=0" class="text-white-50">Wabe Digital Agency</a>
</footer>
